...
class Voicehub(commands.Cog, name="Voicehub"):
    ...
    async def on_voice_state_update(self, member, before: discord.VoiceState, after: discord.VoiceState):
      ...
      if before.channel != None and before.channel != after.channel and before.channel.id != 864060966974390292 and before.channel.id != 867875776028606524:
      ...
      if after.channel != None:
        if after.channel.id == 864060966974390292 or after.channel.id == 867875776028606524:
            ...
            if after.channel.id == 867875776028606524:
                channel = f'『🔊』Canal de {member.display_name}'

                hub = discord.utils.get(member.guild.channels, id=867875776028606524)
            #print(hub.position)
            #print(hub.category)
            ...
            #print(f'{newchan.name}: {newchan.id}')
